...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function displayMonsterList() {
        ...
        let filteredMonsters = monsterData.sort((a, b) => {
        ...
        filteredMonsters.forEach(monster => {
            const cardData = {
                ...
                description: monster["Flavor Text"] || "No description available."
            };

            const monsterCard = createCardElement(cardData);
            monsterListContainer.appendChild(monsterCard);
        });
    }
});
